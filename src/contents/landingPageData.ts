...
export const howItWorksSteps = [
  {
    ...
    description:
      "Integrate with your e-commerce platform, review systems, and customer support tools in minutes",
    features: ["Amazon", "Shopify", "Reviews", "Support Tickets"],
  },
  {
    number: "02",
    title: "AI Analysis",
    description:
      "Our emotion intelligence engine analyzes thousands of customer interactions to identify patterns",
    features: ["Sentiment Analysis", "Pattern Recognition", "Emotion Mapping", "Trend Detection"],
  },
  {
    number: "03",
    title: "Get Insights",
    description:
      "Receive actionable insights with clear recommendations to improve products and reduce returns",
    features: ["Custom Reports", "Real-time Alerts", "Action Items", "ROI Tracking"],
  },
  {
    number: "04",
    title: "Drive Growth",
    description:
      "Implement changes based on insights and watch your retention improve and returns decrease",
    features: ["A/B Testing", "Performance Metrics", "Growth Analytics", "Success Tracking"],
  },
];
